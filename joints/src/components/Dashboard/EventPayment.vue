<template>
		<div>
				<v-container>
						...
						<v-row>
							...
							<v-col md='8' lg='8' xs='12' sm='12' class="col-xs-12" >
									<v-card
                    outlined
                    class="mx-auto mb-5 pt-0 regis-card "
                    > 
                          ...
                          <defs>
                              <linearGradient id="payment-header-gradient">
                ...
                <div class="pl-5">
								  <div class="headline text-left mt-4 font-weight-bold konfirmasi-ungu ">Konfimasi Pembayaran</div>
										
                    <div class="d-flex flex-column ml-4">
                        <div class="title text-left font-weight-regular title-biru-muda">Harap Lakukan Pembayaran Sebelum:</div>
                                <div class="title text-left ml-3 subtitle-purple"> Jumat, 3 Januari  2020 14.00 WIB</div>
                        <div class="title text-left font-weight-regular title-biru-muda ">Yuk Lakukan Tranfers ke:</div>
                                <div class="title text-left ml-3 subtitle-purple">OVO(082112663311/Putri Rizki) </div>
                    <div class="title text-left font-weight-regular title-biru-muda"> 
                      Sebesar:
                    </div>

                    <div 
                      class="title text-left ml-3 subtitle-purple">00 </div>
							...
							<v-col class="col-xs-12" md='4' lg='4' xs='12' sm='12' >
								...
								<v-container class="">
										...
										<div class="d-flex flex-no-wrap">
												<v-card-title class="title pl-0 ">Total harga: {{payment.hari}} </v-card-title><v-spacer></v-spacer> 
												<v-card-title class="title   "> Rp{{payment.harga}}, 00</v-card-title>
										</div>
								...
								<v-card-actions class="pt-0 daftar-action"> 
										<v-btn color="white" rounded  outlined class="mt-0 daftar-button btn-block" min-width="150" @click="overlay = !overlay" >BAYAR</v-btn>
								</v-card-actions>
