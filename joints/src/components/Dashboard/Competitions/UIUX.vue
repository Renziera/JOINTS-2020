            ...
            <v-container>
                <v-row>
                    ...
                    <v-col md="8" lg="8" xs="12" sm="12" class="col-xs-12">
                        <v-card outlined class="mx-auto px-4 pt-4 mb-5 pt-0 regis-card mb-4">
                        ...
                        >Pastikan ketua/anggota 1 merupakan pemegang akun ini, data ini akan otomatis tersimpan di biodata anda</div>
                        ...
                        <v-card outlined class="mx-auto px-4 pt-4 mb-5">
                            <div>
                                ...
                                <v-text-field
                                    ...
                                    placeholder="Nama"
                                ></v-text-field>
                                <div class="subtitle font-weigth-bold">Kartu Tanda Mahasiswa Ketua:</div>
                                <div class="d-flex">
                                    <v-file-input
                                        v-if="!isMemberKetua"
                        ...
                        >
                            <div>
                                ...
                                <div class="subtitle font-weigth-bold">Kartu Tanda Mahasiswa:</div>
                                <div class="d-flex">
                                    <v-file-input
                                        v-if="!isMemberOne"
                                        v-model="team.ktm_1"
                        ...
                        <v-card outlined class="mx-4 ml-0">
                            <v-container class>
                                ...
                                <div class="justify-left">
                                    <div
                                        class="subtitle mt-1 ml-0 subtitle-daftar"
                                    >Kompetisi: UX Design</div>
                                    <div
                                        v-show="team.nama_tim"
                                        class="subtitle mt-1 ml-0 subtitle-daftar"
                                    >Nama Tim: {{team.nama_tim}}</div>
                                    <div
                                        class="subtitle mt-1 ml-0 subtitle-daftar"
                                    >Nama Perguruan Tinggi : {{this.profils.instansi}}</div>
                                    <div
                                        class="subtitle mt-1 ml-0 subtitle-daftar"
                                    >Nama Ketua : {{this.profils.nama}}</div>

                                    <div
                                        class="subtitle mt-1 ml-0 subtitle-daftar"
                                    >Jumlah Anggota : {{this.jumlahAnggota}} orang</div>
                                </div>
                         ...
                         <v-card v-if="isLunas" outlined class="mx-4 ml-0 mt-5" >
                            <v-container class="">
                                ...
                                <v-text-field
                                    class="mt-1"
                                    v-bind:disabled="this.isMakalahUpload"
                                    v-model="youtubeLink"
                                    :rules="[
                                      formValidation,
                                        () => !!youtubeLink || 'This field is required'
                                    ]"
                                    required
                                    outlined
                                    dense
...
export default {
    ...
    methods: {
        ...
        getTeamData() {
            if (
                this.$store.getters.competitions.apps_innovation == null ||
                this.$store.getters.competitions.apps_innovation == undefined
            ) {
                ...
                (this.team.nama_tim = this.$store.getters.competitions.apps_innovation.nama_tim),
                    ...
                    (this.team.nama_2 = this.$store.getters.competitions.apps_innovation.nama_2),
                    (this.team.ktm_ketua = this.$store.getters.competitions.apps_innovation.ktm_ketua),
                    (this.team.ktm_1 = this.$store.getters.competitions.apps_innovation.ktm_1),
                    (this.team.ktm_2 = this.$store.getters.competitions.apps_innovation.ktm_2),
                    (this.team.harga = this.formatHarga(
                        this.$store.getters.competitions.apps_innovation.harga
                    )),
                ...
                if (
                    ...
                    this.$store.getters.competitions.apps_innovation.ktm_1 !=
                    undefined
                ) {
                    this.isMemberOne = true;
                    this.isMemberKetua = true;
                    ...
                    this.$store.getters.competitions.apps_innovation
                        .ktm_ketua != undefined
                ) {
                    this.isMemberKetua = true;
        ...
        async submitTeamData() {
            ...
            let URL_API = `daftar/apps_innovation`;
            const BASE_URL = 'https://api.joints.id';
            Axios.post(BASE_URL + `/${URL_API}`, formData, config)
                .then(response => {
                    this.$store.dispatch('getTeamDataVuex');
