            ...
            <v-app class="white ">
                <v-row>
                    ...
                    <v-col md="8" lg="8" xs="12" sm="12" class="col-xs-12">
                        ...
                        <div class="subtitle mt-1 ml-0 mb-2 subtitle-daftar">
                            Masukan Data Anggota Anda:
                        </div>
                        <v-card outlined class="mx-auto px-4 pt-4">
                            <div>
